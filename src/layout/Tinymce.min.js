...
!(function () {
      ...
      (jr(e) &&
        !1 ===
          ...
          jn((i = e)) &&
            qr(i.data) &&
            !1 ===
              ((n = i), (r = kt.fromDom(a)), hr(kt.fromDom(n), 'pre,code', R(je, r)).isSome()))) ||
      (zn((o = e)) &&
        'A' === o.nodeName &&
        !o.hasAttribute('href') &&
  ...
  function ro(i) {
    ...
    function g(e, t, n) {
      ...
      for (var a = Zr(e), u = a.length; u--; )
        (i = { attributes: r((o = Zr([s, t].join(' ')))), attributesOrder: o, children: r(n, ei) }),
          (c[a[u]] = i)
    }
    function p(e, t) {
    ...
    ni(
      ...
      i.valid_elements
        ...
        : (ni(m, function (e, t) {
          ...
          ni(D, function (e, t) {
            S[t] &&
              (i.padd_empty_block_inline_children && (S[t].paddInEmptyBlock = !0),
              (S[t].removeEmpty = !0))
          }),
  ...
  function io(b, e) {
    ...
    for (var t = ('\\" \\\' \\; \\: ; : ' + k).split(' '), N = 0; N < t.length; N++)
      (E[t[N]] = k + N), (E[k + N] = t[N])
    return {
      toHex: function (e) {
      ...
      (K((i = t).preventDefault) || ao(i)) &&
        ((a.preventDefault = function () {
          ;(a.defaultPrevented = !0),
            ...
            y(t.preventDefault) ? t.preventDefault() : ao(t) && (t.returnValue = !1)
        }),
        (a.stopPropagation = function () {
          ;(a.cancelBubble = !0),
            (a.isPropagationStopped = w),
            y(t.stopPropagation) ? t.stopPropagation() : ao(t) && (t.cancelBubble = !0)
        }),
              ...
              f.domLoaded && 'ready' === u && 'complete' === e.readyState
                ...
                : (f.hasMouseEnterLeave ||
                  ...
                  f.hasFocusIn ||
                    ...
                    (c = function (e) {
                      ;((e = lo(e || d.event)).type = 'focus' === e.type ? 'focusin' : 'focusout'),
                        f.executeHandlers(e, i)
                    })),
                  (a = f.events[i][u])
                    ? 'ready' === u && f.domLoaded
                ...
                if (t)
                  for (r = l.length; r--; )
                    l[r].func === t &&
                      ...
                      (i[o] = l))
                ;(t && 0 !== l.length) ||
                  (delete i[o], co(n, l.fakeName || o, l.nativeHandler, l.capture))
              }
          } else
            ne(i, function (e, t) {
  ...
  var sa = function (e, t, n, r) {
    ...
    if (
      ((t ? t.ownerDocument || t : Ri) !== wi && xi(t), (n = n || []), !e || 'string' != typeof e)
    )
      return n
    ...
    return e.first
      ...
      : function (e, t, n) {
          ...
          if (n) {
            ...
            for (; (e = e[u]); )
              if (1 === e.nodeType || s) {
                if ((r = (o = e[Ai] || (e[Ai] = {}))[u]) && r[0] === Di && r[1] === c)
                  return (i[2] = r[2])
  ...
  ;(fi = sa.support = {}),
    ...
    (sa.matchesSelector = function (e, t) {
      if (
        ...
        (t = t.replace(Ji, "='$1']")),
        fi.matchesSelector && Ei && (!Ni || !Ni.test(t)) && (!ki || !ki.test(t)))
      )
        try {
                ...
                Oi(e, function (e) {
                  return t.test(
                    ('string' == typeof e.className && e.className) ||
                      (typeof e.getAttribute != Ii && e.getAttribute('class')) ||
                      '',
                  )
                }))
            )
          ...
          lang: la(function (n) {
            return (
              ...
              function (e) {
                var t
                do {
                  if ((t = Ei ? e.lang : e.getAttribute('xml:lang') || e.getAttribute('lang')))
    ...
    (hi = sa.compile =
      function (e, t) {
        ...
        if (!i) {
                      ...
                      return (
                        ...
                        la(function (e, t, n, r) {
                          var o,
                            ...
                            d = p ? (v || (e ? m : c || h) ? [] : t) : f
                          if ((p && p(f, d, n, r), h))
                            for (o = ba(d, s), h(o, [], n, r), i = o.length; i--; )
                              (a = o[i]) && (d[s[i]] = !(f[s[i]] = a))
                          if (e) {
                            if (v || m) {
                              if (v) {
          ...
          ;(i = Pi(
            e,
            ((h = o), (b = 0 < (v = r).length), (y = 0 < h.length), b ? la(a) : a),
          )).selector = e
        }
      ...
      function (e, t, n, r) {
        ...
        if (((n = n || []), 1 === l.length)) {
          ...
          for (
            ...
            if (
              (s = di.find[u]) &&
              (r = s(a.matches[0].replace(ua, li), (ia.test(i[0].type) && ma(t.parentNode)) || t))
            ) {
  ...
  ;(Ea.fn = Ea.prototype =
    {
      ...
      add: function (e, t) {
        ...
        if (!1 !== t)
          for (
            n = Xa.unique(this.toArray().concat(Xa.makeArray(e))), this.length = n.length, r = 0;
            r < n.length;
            r++
          )
            this[r] = n[r]
      ...
      remove: function () {
        for (var e, t = this.length; t--; )
          (e = this[t]), Oa.clean(e), e.parentNode && e.parentNode.removeChild(e)
        return this
      },
      empty: function () {
        for (var e, t = this.length; t--; )
      ...
      function (r, o) {
        Ea.fn[r] = function (t) {
          ...
          this.each(function () {
            ...
            1 < this.length &&
              (Ba[r] || (n = Xa.unique(n)), 0 === r.indexOf('parents') && (n = n.reverse()))
          var e = Xa(n)
  ...
  function hu(e, t) {
    ...
    pu(e)
      ...
      : ((r = t), (o = gu((n = e), 'class').concat([r])), pn(n, 'class', o.join(' ')))
  }
  function vu(e, t) {
  ...
  function wu(e, t) {
    ...
    Kt(i, ((n = t), ((r = (o || document).createElement('div')).innerHTML = n), Dn(kt.fromDom(r)))),
      Xt(e),
      Pn(e, i)
  }
  function Su(e, t) {
          ...
          (function (e) {
            ...
            function t(e, t) {
              ...
              if (t < e.data.length) {
                ...
                if (Iu(e.data[t - 1]) && (n.setStart(e, t), n.setEnd(e, t + 1), !zu(n)))
                  return r(ju(us(n), !1)), o
              }
              0 < t && (n.setStart(e, t - 1), n.setEnd(e, t), zu(n) || r(ju(us(n), !1))),
                t < e.data.length &&
                  (n.setStart(e, t), n.setEnd(e, t + 1), zu(n) || r(ju(us(n), !0)))
            }
            var o = [],
              n = e.container(),
              i = e.offset()
            ...
            if (Ju(n))
              if (e.isAtEnd()) {
                ...
                ts(u) && !os(u) && ((!Zu(u) && !Zu(a) && ts(a)) || r(ju(us(u), !1))),
                  ts(a) && r(ju(us(a), !0))
              }
            return o
          })(ss(t, n)))
      ...
      ? ((r = t),
        bc((n = e)) && r.container() === n
          ? ((a = Us((o = n).data.substr(0, (i = r).offset()))),
            ...
            0 < (a.text + u.text).length ? (zs(o), ss(o, i.offset() - a.count)) : i)
          : Hs(n, r))
  ...
  function $s(e, i, a, u) {
    function s() {
      !(function () {
        for (
          var e = bu(kt.fromDom(i), '*[contentEditable=false],video,audio,embed,object'), t = 0;
          t < e.length;
          t++
        ) {
          var n,
          ...
          Ao(o) &&
            ...
            (o = r.nextSibling),
            _o(o) && (1 === (n = o.data).length ? o.parentNode.removeChild(o) : o.deleteData(0, 1))
        }
      })(),
        l && (yc(l), (l = null)),
        f.on(function (e) {
      ...
      show: function (e, t) {
        ...
        return (
          ...
          (c = _r.setInterval(function () {
            u()
              ? Xa('div.mce-visual-caret', i).toggleClass('mce-visual-caret-hidden')
              : Xa('div.mce-visual-caret', i).addClass('mce-visual-caret-hidden')
          }, 500)),
  ...
  function zc(o, i, a) {
    return Ql(o, i, a).bind(function (e) {
      return Js(a, e, i) &&
        ...
        (n = e),
        o
          ? !Uc(t, n) && (ss.isTextPosition((r = t)) || !Wn(r.getNode())) && Fc(t) && Mc(n)
          : !Uc(n, t) && Mc(t) && Fc(n))
        ? Ql(o, i, e)
        : ve.some(e)
      var t, n, r
  ...
  function Hc(e, t) {
    ...
    return jn(u)
      ...
      ? jr(u)
        ...
        : ((r = t), (o = u), (i = (n = e) ? ss.before(o) : ss.after(o)), Ql(n, r, i))
      : ve.none()
  }
  function jc(e) {
    return zn(e) && e.id === of
  ...
  function xl(e, t, n, r, o) {
    ...
    for (var i = lf(e, r), a = 0; a < i.length; a++)
      for (var u = 0; u < t.length; u++) {
        var s = t[u]
        if ((!V(s.collapsed) || s.collapsed === n.collapsed) && ml(s) && e.is(i[a], s.selector))
          return i[a]
      }
    return r
  }
  ...
  function kl(e, t, n, r) {
    ...
    return (
      ...
      zn(a) &&
        a.hasChildNodes() &&
        ((a = Lu(a, t.collapsed ? u : u - 1)), jn(a) && (u = a.nodeValue.length)),
      (o = hl(s, o)),
      (a = hl(s, a)),
      El(o) &&
  ...
  var jl,
    ...
    Jl = function (e, t, n) {
      ...
      if (t.isEqual(ss.after(n)) && n.lastChild) {
        if (((i = ss.after(n.lastChild)), e < 0 && Yl(n.lastChild) && Kl(n.lastChild)))
    ...
    function g(e) {
      ...
      ;(N = u * b[2] + w),
        ...
        ((c(p) || f(p)) && !1 !== l.getParam('resize_img_proportional', !0, 'boolean')
          ...
          : Lf.modifierPressed(e)) &&
          (L(u) > L(s) ? ((_ = I(N * E)), (N = I(_ / E))) : ((N = I(_ / E)), (_ = I(N * E)))),
        m(h, N, _),
        (t = b.startPos.x + u),
        (n = b.startPos.y + s),
    ...
    return (
      t === r && jn(t)
        ? 0 < n &&
          ...
          n < o
            ? ((t = r = Of(r, (o -= n)).previousSibling), (o = r.nodeValue.length), (n = 0))
            : (o = 0))
        : (jn(t) && 0 < n && n < t.nodeValue.length && ((t = Of(t, n)), (n = 0)),
          jn(r) &&
            0 < o &&
  ...
  var Mf,
    ...
    Uf =
      ...
      }),
      {
        set: function (e, t) {
          if (!E(t) && !t.match(/^[0-9]+$/))
            throw new Error(Mf + '.set accepts only positive integer values. Value was ' + t)
          var n = e.dom
                  ...
                  g.replace(B, function (e, t, n, r, o) {
                    return (
                      (function (e, t, n, r, o) {
                        var i
                        if (
                          ((n = Vd((t = t.toLowerCase()) in I ? t : k(n || r || o || ''), s)),
                          M &&
                            !l &&
    ...
    return ve
      ...
      .bind(function (e) {
        ...
        return (!Im(d, 0) || Lm(f, m)
          ...
          (r = (n = l).data),
          (o = ss(n, r.length - 1)),
          Im(r, r.length - 1) && !Lm(t, o) && ((n.data = r.slice(0, -1) + ' '), 1))
          ? ve.some(e)
          : ve.none()
      })
  }
  ...
  function qm(e, t) {
    return (
      ...
      (o = (n = t).container()),
      (i = n.offset()),
      !1 === ss.isTextPosition(n) && o === r.parentNode && i > ss.before(r).offset()
  ...
  function $m(e) {
    return jr(e.previousSibling)
      ? ve.some(((t = e.previousSibling), jn(t) ? ss(t, t.data.length) : ss.after(t)))
      : e.previousSibling
  ...
  function Ng(e, t, n) {
    ...
    if (m.isDefaultPrevented())
        ...
        u.isCollapsed() ||
          (function (e) {
            ...
            var r,
              ...
              i = n
            null !== (r = o) && r === t.getParent(i.endContainer, hp) && Tl(kt.fromDom(r), i)
              ? mp(e, n, kt.fromDom(o))
      ...
      if (!0 === n.paste && xg(e.schema, B) && Sg(s, I))
        return (g = kg(f, s, u.getRng(), B)), u.setRng(g), void e.fire('SetContent', m)
      if (
        ((function () {
          ...
          : ((t = u),
            ...
            0 === (r = s).length || /^\s+$/.test(r)
              ? ((i = '<br data-mce-bogus="1">'),
                ...
                (r =
                  (a = ks(t)) && t.schema.isValidChild(n.nodeName.toLowerCase(), a.toLowerCase())
  ...
  function Mp(e, r, o, t, i) {
    ...
    if ('all' !== r.remove) {
      Ah(r.styles, function (e, t) {
        ;(e = ul(u, il(e, o), t + '')),
          E(t) && ((t = e), (i = null)),
          (!r.remove_similar && i && !Rh(sl(u, i, t), e)) || u.setStyle(b, t, ''),
          (n = !0)
      }),
        n &&
          '' === u.getAttrib(b, 'style') &&
              ...
              ((d.list_block && Rh(f, d.list_block)) ||
                Y(xe(f.childNodes), function (e) {
                  ol(l, v, e.nodeName.toLowerCase())
                    ? m
                      ? m.appendChild(e)
                      : ((m = Pp(h, e, v)), h.setAttribs(m, l.settings.forced_root_block_attrs))
                    : (m = null)
                }))
            : h.isBlock(f) &&
              !h.isBlock(p) &&
              ...
              Ip(h, f, !0) || Ip(h, f.lastChild, !1, !0) || f.appendChild(h.create('br')))),
      ...
      return (function (e, t, n, r, o, i, a, u) {
        ...
        if (n) {
          ...
          !i || (a.mixed && l.isBlock(n)) || (r = l.split(n, r)),
            s && (o.parentNode.insertBefore(s, o), c.appendChild(o), gl(a) && Ap(l, a, 0, s))
        }
        return r
      })(u, m, t, e, e, !0, g, c)
    }
      ...
      if (g.split) {
        if (((t = Bf(t)), (r = Op(u, t, !0)) !== (o = Op(u, t)))) {
          if (((r = Bp(r, !0)), (o = Bp(o, !1)), Tp(h, r, o))) {
            ...
            return (
              a(Lp(h, n, !0, 'span', { id: '_start', 'data-mce-type': 'bookmark' })), void d(!0)
            )
          }
          if (Tp(h, o, r))
            return (
              (n = ve.from(o.lastChild).getOr(o)),
              a(Lp(h, n, !1, 'span', { id: '_end', 'data-mce-type': 'bookmark' })),
              void d(!1)
            )
      ...
      v = function (t) {
        ...
        Y(['underline', 'line-through', 'overline'], function (e) {
          zn(t) &&
            ...
            t.parentNode &&
            cl(h, t.parentNode) === e &&
            Fp(u, { deep: !1, exact: !0, inline: 'span', styles: { textDecoration: e } }, null, t)
        })
      }
    if (e)
      return (
        el(e) ? ((n = h.createRng()).setStartBefore(e), n.setEndAfter(e), t(n)) : t(e),
        void xf(u, s, e, c)
      )
    ...
    return (
      ...
      Y(l.split(','), function (t) {
        ...
        b(m)
          ...
          : r.withVars.push({ state: iu(e()), similar: d, vars: m, callback: f })
      }),
      c.set(g),
      {
        unbind: function () {
      ...
      editor: {
        getContent: function (e, t) {
          return (
            ...
            ve
              .from(d.getBody())
              .fold(J('tree' === m.format ? new Hd('body', 11) : ''), function (e) {
                return (
                  (t = d),
                  (r = e),
                  (o = g),
          ...
          return (function (e, t, n) {
            ...
            var a,
              ...
              g =
                ...
                (f = Ed(a, _l(l))),
                (d = u.contextual ? nh(kt.fromDom(a.getBody()), f).dom : s.cloneContents()) &&
                  c.appendChild(d),
      ...
      function g(e, t) {
        ...
        return (
          Th(e, function (e) {
            return (
              !!ml(e) &&
              ((V(e.collapsed) && e.collapsed !== a) || !u.is(t, e.selector) || jc(t)
                ? void 0
                : (N(t, e), !(n = !0)))
            )
          }),
      ...
      if ('false' !== u.getContentEditable(s.getNode()))
        A &&
          (r
            ? el(r)
              ? g(_, r) ||
                ((e = u.createRng()).setStartBefore(r), e.setEndAfter(r), o(u, kl(S, e, _), !0))
              : o(u, r, !0)
            : a && gl(A) && !Rl(S).length
            ? (function (e, t, n) {
                var r,
          ...
          for (var t, n, r, o = e.length; o--; )
            ('ul' !== (r = (n = e[o]).parent).name && 'ol' !== r.name) ||
              (n.prev && 'li' === n.prev.name
                ? n.prev.append(n)
                : ((t = new Hd('li', 1)).attr('style', 'list-style-type: none'), n.wrap(t)))
        }),
      p.validate &&
        h.getValidClasses() &&
                ...
                if (i) {
                    ...
                    if ((t = l.firstChild) && 3 === t.type)
                      if (0 < (n = t.value.replace(x, '')).length) (t.value = n), (t = t.next)
                        ...
                        for (r = t.next, t.remove(), t = r; t && 3 === t.type; )
                          (n = t.value),
                            (r = t.next),
                            (0 !== n.length && !E.test(n)) || (t.remove(), (t = r)),
                            (t = r)
                  ...
                  (function () {
                    ...
                    ? g[l.name]
                      ...
                      : l.unwrap()
                    : i.paddEmpty &&
                      ((gv((o = l), '#text') && o.firstChild.value === xo) || a) &&
                      $h(A, s, g, l),
                    (l = u)
                }
              },
                        ...
                        if (l && 1 < m.length)
                          if (R.isValidChild(l.name, c.name)) {
                            ...
                            Wh(R, n, r, s)
                              ...
                              (l = m[0]),
                              (Wh(R, n, r, l) || gv(l, 'br')) && l.empty().remove()
                          } else a(c)
                        else
                          c.parent &&
                            ('li' !== c.name
            ...
            (function () {
              ...
              if (R.isValidChild(_.name, y.toLowerCase())) {
                for (; t; ) {
                  var r = t.next
                  3 === t.type ||
                  (1 === t.type && 'p' !== t.name && !g[t.name] && !t.attr('data-mce-type'))
                    ? (n || ((n = m(y, 1)).attr(A.forced_root_block_attrs), _.insert(n, t)),
                      n.append(t))
                    : (e(n), (n = null)),
                    (t = r)
                }
        ...
        serialize: function (e, t) {
          ...
          return 'tree' === T.format
            ...
            : ((k = I),
              ...
              N.no_events || !k
                ? D
                : ((A = k), (R = _e(_e({}, N), { content: D })), A.fire('PostProcess', R).content))
        },
    ...
    var o,
      ...
      h =
        ((i =
          ...
          (s = m),
          (c = p),
          (a = e) && (0, (f = (l = u).sections()), nv(l, 'mobile') && 'mobile' === f.mobile.theme)
            ? U(c, R(T, Av))
            : a && nv(u, 'mobile')
            ? c
            : s)),
  ...
  function Vv(e) {
    ...
    e.contentCSS = e.contentCSS.concat(
      dy(
        ...
        X(n) ? A(n.split(','), Je) : S(n) ? n : !1 === n || t.inline ? [] : ['default']),
      ),
      dy(e, Os(e)),
    )
  }
                    ...
                    return (
                      e.status && l.getParam('images_replace_blob_uris', !0, 'boolean')
                        ...
                        : e.error &&
                          ...
                          (n = e.error.message),
                          Uv(l, cu.translate(['Failed to upload image: {0}', n]))),
  ...
  function Jv(e, t) {
    function m(e) {
      ...
      var t,
        ...
        r = n
      return (
        (t = o).classes.length && py.addClass(r, t.classes.join(' ')), py.setAttribs(r, t.attrs), n
      )
    }
    var n,
      o,
    ...
    return e && e.length
      ? ((n = m((o = e[0]))), (r = py.create('div')).appendChild(p(n, e.slice(1), o.siblings)), r)
      : ''
  }
  function Qv(e) {
    var t,
        ...
        if (
          !(
            ('background-color' === e &&
              ...
              ((t = py.getStyle(n.getBody(), e, !0)), '#ffffff' === py.toHex(t).toLowerCase())) ||
  ...
  function bb(e, t, n) {
    return (
      vb(!0, t),
      vb(!1, n),
      (Ve((o = n), (r = t)) ? ((i = ym(r, o)), ve.from(i[i.length - 1])) : ve.none()).fold(
        R(hb, e, t, n),
        R(pb, e, t, n),
      )
    )
      ...
      e
        ? function (e) {
            if (Ey(e.previousSibling))
              return zb(e.previousSibling) || e.previousSibling.appendData(wo), e.previousSibling
        ...
        : function (e) {
            if (Ey(e.nextSibling))
              return Ub(e.nextSibling) || e.nextSibling.insertData(0, wo), e.nextSibling
  ...
  function ey(e) {
    return (
      !1 ===
      ((t = Ay(e)),
      'rtl' === Za.DOM.getStyle(t, 'direction', !0) || ((n = t.textContent), by.test(n)))
    )
    var t, n
  }
  function ty(e, t, n) {
  ...
  function iy(a, e, u, t, n, s) {
    return dn(ab(e, u, t), ab(e, u, n), function (e, t) {
      return e !== t && ((r = t), (o = Gs(e, (n = u))), (i = Gs(r, n)), o && o === i)
        ? _y.after(a ? e : t)
        : s
      var n, r, o, i
    }).getOr(s)
    ...
    for (var o, i, a, u, s = Ic(n), c = r, l = []; c; ) {
      ...
      if (Wn(f.getNode(!1)))
        return t === uc.Forwards
          ? { positions: Dy(t, l).concat([f]), breakType: ly.Br, breakAt: ve.some(f) }
          : { positions: Dy(t, l), breakType: ly.Br, breakAt: ve.some(f) }
      if (f.isVisible()) {
        if (e(c, f)) {
          var d =
            ((o = c),
            Wn((i = f).getNode(t === uc.Forwards)) ? ly.Br : !1 === Js(o, i) ? ly.Block : ly.Wrap)
    ...
    if (
      ...
      (a = Gy(
        (function (e, r, t) {
          ...
          var o = []
          return (
            o.push(r), Jy(My.Up, e, R(n, Tu), r.node, t), Jy(My.Down, e, R(n, Ou), r.node, t), o
          )
        })(e, a, r(a)),
        t,
        r,
  ...
  function s0(e, t, n) {
    return (
      ...
      !!y(o.selection.getSel().modify) &&
        (r && Fr(a) ? Ry(!0, o.selection, a) : !(r || !Ur(a)) && Ry(!1, o.selection, a)))
    )
    var r, o, i, a
  }
  function c0(g) {
        ...
        !Is(g) ||
          ...
          Y(
            $(
              (s = U(
                A(
                  bu(kt.fromDom(a.getRoot()), '*[data-mce-selected="inline-boundary"]'),
                  function (e) {
                    return e.dom
                  },
                ),
    ...
    e.queryCommandState('InsertUnorderedList') ||
      ...
      Y($C(e), function (e) {
        var t,
          ...
          u = C0(d, kt.fromDom(a))
        'outdent' === r
          ? ((t = Math.max(0, y0(a.style[u]) - o)), n.setStyle(a, u, t ? t + i : ''))
            ...
            jn((h = s)) || (zn(h) && !_0(p, h) && !Jc(h))
              ? (function (e, t) {
                  if (jn(t)) {
                    ...
                    if (/^\s+$/.test(t.nodeValue) && (!t.nextSibling || _0(e, t.nextSibling)))
                      return 1
                  }
                })(u, s)
                ? ((s = (n = s).nextSibling), o.remove(n))
                : (t || ((t = o.create(l, Ns(e))), s.parentNode.insertBefore(t, s), (r = !0)),
                  (s = (n = s).nextSibling),
                  t.appendChild(n))
    ...
    return pr(kt.fromDom(e.container()), mo, t)
      ...
      .exists(function () {
        if (
          ((d = b),
          (m = y),
          v ? ((p = d.dom), zy(p, m).breakAt.isNone()) : ((g = d.dom), Uy(g, m).breakAt.isNone()))
        ) {
          var e =
            ((t = b),
            (r = x),
  ...
  function fC(a, e) {
    ...
    function r() {
      ;(u = /^(H[1-6]|PRE|FIGURE)$/.test(C) && 'HGROUP' !== x ? t(p) : t()),
        a.getParam('end_container_on_empty_block', !1) && uC(c, y) && c.isEmpty(b)
          ? (u = c.split(y, b))
          : c.insertAfter(u, b),
        Z0(a, u)
    }
        ...
        (m = (function (e, t, n, r) {
          ...
          if (!m || !uC(f, m)) {
            ...
            if (i && e.schema.isValidChild(s, l.toLowerCase())) {
              for (
                lC(e, (o = f.create(l))), i.parentNode.insertBefore(o, i), a = i;
                a && !f.isBlock(a);
          ...
          N !== E.getBody() &&
            ...
            oC(N, _, !0) && oC(N, _, !1)
              ? tC(N, 'LI')
                ? ((T = rC(N)),
                  I.insertAfter(D, T),
                  (null === (L = (P = N).parentNode) || void 0 === L ? void 0 : L.firstChild) === P
                    ? I.remove(T)
                    : I.remove(N))
                : I.replace(D, N)
              : (oC(N, _, !0)
    ...
    function a(e) {
      ...
      e.isDefaultPrevented() ||
        ((t = e.dataTransfer) &&
          ...
          (e.preventDefault(), 'drop' === e.type && Uv(i, 'Dropped file type is not supported')))
    }
    function u(e) {
      gd(i, e.target) && a(e)
    }
    ...
    return (
      xt.ceFalse &&
        ...
        l.on('click', function (e) {
          var t = f1(l, e.target)
          t &&
            (F1(t) && (e.preventDefault(), l.focus()), M1(t) && y.isChildOf(t, b.getNode()) && h())
        }),
        ...
        (e = du(function () {
          ...
          n.removed ||
            ...
            ((e = n.selection.getRng()).collapsed && ((t = _b(n, e, !1)), n.selection.setRng(t)))
        }, 0)),
            ...
            a.on('dragstart', function (e) {
              ...
              ;(t = e).dataTransfer &&
                ...
                0 < (n = a.selection.getContent()).length &&
                  ((r = E + escape(a.id) + ',' + escape(n)), t.dataTransfer.setData(k, r)))
            }),
            a.on('drop', function (e) {
              var t, n, r, o
              u(e) ||
                ((t =
                  e.dataTransfer && (o = e.dataTransfer.getData(k)) && 0 <= o.indexOf(E)
  ...
  function x1(t, e) {
    ...
    ;(v.disabled = !0),
      ...
      t.readonly ||
        (t.inline && 'static' === U1.getStyle(v, 'position', !0) && (v.style.position = 'relative'),
      ...
      (E = function (e, t) {
        ...
        !(function (e) {
          if (rb(e)) {
            var t = e.keyCode
            return (
              !ob(e) && (Lf.metaKeyPressed(e) || e.altKey || (112 <= t && t <= 123) || T(hy, t))
            )
          }
        })(e) &&
          ((n = C.getBody()),
    ...
    return (
      ...
      X(Ls(e))
        ...
        ? ((n = (t = e).getElement()),
          ...
          r)
        : ((u = (o = e).getElement()),
          o.inline ? E1(null) : ((i = u), (a = H1.create('div')), H1.insertAfter(a, i), E1(a)))
    )
  }
  function N1(e) {
    var n, t, r, o, i, a, u, s
    e.fire('ScriptsLoaded'),
      ...
      X(a)
        ? ((o.settings.theme = S1(a)),
          ...
          o.theme.init && o.theme.init(o, Iv.urls[a] || o.documentBaseUrl.replace(/\/$/, ''), o.$))
        : (o.theme = {}),
      (s = []),
  ...
  function mx(e) {
    ...
    yx(Cx(e.toLowerCase(), '+'), function (e) {
      e in wx
        ...
        : ((n.charCode = e.charCodeAt(0)), (n.keyCode = xx[e] || e.toUpperCase().charCodeAt(0)))
    })
    var r = [n.keyCode]
        ...
        'focus' !== e &&
          ...
          (n.removed ||
            (t
              ...
              : n.initialized &&
                (n.dom.unbind(cx(n, e), e, n.delegates[e]), delete n.delegates[e])))
      },
  ...
  var kx = Za.DOM,
    ...
    Dx =
            ...
            ? t.getElement() &&
              ...
              (i = t.getElement().form || V1.getParent(e, 'form')) &&
                ...
                t.getParam('hidden_input') &&
                  !Hn(t.getElement()) &&
                  (V1.insertAfter(V1.create('input', { type: 'hidden', name: e }), e),
                  (t.hasHiddenInput = !0)),
      ...
      (Tx.prototype.hide = function () {
        ...
        e.hidden ||
          ...
          e.inline
            ...
            : (kx.hide(e.getContainer()), kx.setStyle(e.id, 'display', e.orgDisplay)),
          (e.hidden = !0),
          e.fire('hide'))
      }),
      ...
      (Tx.prototype.resetContent = function (e) {
        void 0 === e ? Qh(this, this.startContent, { format: 'raw' }) : Qh(this, e),
      ...
      (Tx.prototype.getContainer = function () {
        return (
          this.container || (this.container = kx.get(this.editorContainer || this.id + '_parent')),
          this.container
        )
      }),
  ...
  function Tx(e, t, n) {
    ...
    ;(this.plugins = {}),
      ...
      this.settings.referrer_policy &&
        ...
        Za.DOM.styleSheetLoader._setReferrerPolicy(this.settings.referrer_policy)),
  ...
  function Bx(e) {
    e !== Hx &&
      (e ? Xa(window).on('resize scroll', Ox) : Xa(window).off('resize scroll', Ox), (Hx = e))
  }
  function Px(t) {
    var e = Vx
    delete jx[t.id]
  ...
  var Lx,
    ...
    $x = _e(_e({}, px), {
              ...
              r.types
                ...
                : (Et.each(o, function (e) {
                    ...
                    ;(t = c.get(e.id)) &&
                      ...
                      (Px(t), t.unbindAllNativeEvents(), t.destroy(!0), (t.removed = !0))
                  }),
                  0 ===
            ...
            return (
              ...
              l(r.get(n.id))
                ...
                : (Px(n) && r.fire('RemoveEditor', { editor: n }),
                  0 === Vx.length && window.removeEventListener('beforeunload', Lx),
                  n.remove(),
                  Bx(0 < Vx.length),
                  n)
            )
      ...
      _setBaseUrl: function (e) {
        ;(this.baseURL = new Yd(this.documentBaseURL).toAbsolute(e.replace(/\/+$/, ''))),
          (this.baseURI = new Yd(this.baseURL))
      },
    })
  function Wx(e, t, n) {
    ...
    hw =
      ...
      (vw.prototype.send = function (e) {
        ...
        ;(o.success = function (e, t) {
          ;(e = void 0 === (e = dw.parse(e)) ? { error: 'JSON Parse error.' } : e).error
...
tinymce.baseURL =
  'https://cdn.tiny.cloud/1/qagffr3pkuv17a8on1afax661irst1hbr4e6tbv888sz91jc/tinymce/5.10.7-133'
