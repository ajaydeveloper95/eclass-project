...
function RelatedCourse() {
  ...
  const usersDataCourseInclude = [
    {
      id: 1,
      RelatedCourse: 'Samppa Nori',
      status: 'false',
    },
    {
      id: 2,
      RelatedCourse: 'Estavan Lykos',
      status: 'true',
    },
    {
      id: 3,
      RelatedCourse: 'Chetan Mohamed',
      status: 'true',
    },
    {
      id: 4,
      RelatedCourse: 'Derick Maximinus',
      status: 'false',
    },
  ]
    ...
    <div>
      <div>
        ...
        <CButton className="mx-3" color="primary" variant="outline">
          <CIcon icon={cilPlus}></CIcon> Add Related Course
        </CButton>
      </div>
      <hr />
      <div>
